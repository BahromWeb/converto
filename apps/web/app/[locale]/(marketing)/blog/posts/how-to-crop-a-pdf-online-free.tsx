...
const Body = (
  <>
    <Lead>Scanned PDFs from book pages have huge blank margins eating half the page. Slide decks exported from PowerPoint have presenter notes wasting the bottom third. Both call for cropping — trimming the chrome so the content fills the page. Takes about fifteen seconds.</Lead>

    <Section>
      <H2 id="why">When you actually need Crop PDF</H2>
      <p>Book scans with huge margins, decks with presenter notes you don't want, receipts with whitespace dominating the page, contracts that came from a wider page size and need to fit a different sheet.</p>
    </Section>

    <Section>
      <H2 id="how">How to crop pdf, step by step</H2>
      <Step n={1} title="Open the tool">Go to <Link href="/crop" className="text-primary hover:underline">convertpdfgo.com/crop</Link>. No account, no email, no installation.</Step>
      ...
      <Step n={3} title="Configure your run">Set the four margins in PDF points (1 pt = 1/72 inch).</Step>
    ...
    <Section>
      ...
      <Problem title="Margins are wrong unit">We use PDF points (1 pt = 1/72 inch). 72 points = 1 inch = 25.4 mm. Type 36 to remove half an inch from each side.</Problem>
      <Problem title="Cropped page is empty">You set margins larger than the actual content area. Reduce the margins or check the original page dimensions.</Problem>
      <Problem title="Wanted to crop one page differently">Run two passes — one for the odd page, one for the rest. Merge the results.</Problem>
    </Section>
    ...
    <Section>
      ...
      <Faq q="Will it cut content or just whitespace?">Whatever you set. If your margins fall inside the content, content gets cut. We don't auto-detect — you set the box.</Faq>
      <Faq q="Can I crop each page differently?">Not in one job. Run separate passes for pages with different margins, then merge the outputs.</Faq>
    ...
    <Section>
      ...
      <Callout>Now you can <Link href="/rotate" className="font-semibold text-primary hover:underline">Rotate PDF</Link>, <Link href="/merge" className="font-semibold text-primary hover:underline">Merge PDF</Link>, or <Link href="/compress" className="font-semibold text-primary hover:underline">Compress PDF</Link>. All free.</Callout>
      <p>Or browse <Link href="/tools" className="text-primary hover:underline">our full list of 49 free PDF tools</Link>.</p>
    </Section>
  </>
);

export const cropPdfPost: BlogPost = {
  slug: "how-to-crop-a-pdf-online-free",
  title: "How to Crop a PDF Online — Free, Margin Control, No Watermark",
  description: "Trim margins from a PDF, or focus on one region across every page. Free, no sign-up, no watermark.",
  date: "2021-07-04",
  modified: "2026-06-01",
  author: "convertpdfgo team",
  tag: "Guide",
  readingMinutes: 7,
  keywords: ["crop pdf", "trim pdf margins", "crop pdf online free", "remove pdf margins", "pdf crop tool"],
  heroEmoji: "✂️",
  toc: [
